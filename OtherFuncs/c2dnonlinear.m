function [fprinted,dfprinted_dxk,dfprinted_dvk] = c2dnonlinear(xk,uk,vk,tk,tkp1,nRK,fscriptname,idervflag)
% Continuous-time to discrete-time nonlinear model conversion function
...
%
   ...
   for jj = 1:nRK
      ...
      % Combine Runge-Kutta terms into full integrated term
