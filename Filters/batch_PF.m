...
%% PF Methods
    methods
        % PF constructor
        % Input order:
        % fmodel,hmodel,modelFlag,kInit,xhatInit,PInit,uhist,zhist,thist,Q,R,nRK,Np,resampleFlag
        function PFobj = batch_PF(varargin)
            % Prepare for superclass constructor
            if nargin == 0
                fprintf('Instantiating empty batch PF class\n\n')
                super_args = {};
            elseif nargin == 1
