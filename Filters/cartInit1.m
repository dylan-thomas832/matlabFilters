function [x1,P1] = cartInit1(zhist,thist)
...
% Initial estimate
x1 = [psi0; yr0; psidot0; vr0];

% Initial covariance
P1 = zeros(5,5);
P1(1,1) = (2*sig_rhoa*sig_rhob)/(vr0^2*(thist(2)-thist(1))^2);
P1(2,2) = sig_rhoa*sig_rhob;
P1(3,3) = sig_rhoa*sig_rhob;
P1(4,4) = (qtilsteer*tausteer)*0.5;
P1(5,5) = (2*sig_rhoa*sig_rhob)/(thist(2)-thist(1))^2;
end